...
# All CVHT values years and lakes go into CVHT_JAS_STandardized data or the file below 
write_csv(cvht_JAS_standardized, file.path(base_dir, "CVHT_Results_All_Lakes.csv"))
